...
uses
  ...
  uDMAboutBox in '..\..\lib-externes\Gamolf-FMX-Game-Template\starter-kit-src\uDMAboutBox.pas' {AboutBox: TDataModule},
  uDMAboutBoxLogoStorrage in '..\..\lib-externes\Gamolf-FMX-Game-Template\starter-kit-src\uDMAboutBoxLogoStorrage.pas' {dmAboutBoxLogo: TDataModule},
  ...
  uTranslate in '..\..\lib-externes\Gamolf-FMX-Game-Template\starter-kit-src\uTranslate.pas',
  uConfig in '..\..\lib-externes\Gamolf-FMX-Game-Template\starter-kit-src\uConfig.pas',
  uSceneBackground in 'uSceneBackground.pas' {SceneBackground: TFrame},
  uScene in '..\..\lib-externes\Gamolf-FMX-Game-Template\starter-kit-src\uScene.pas',
  ...
  uUIElements in '..\..\lib-externes\Gamolf-FMX-Game-Template\starter-kit-src\uUIElements.pas',
  uGameData in '..\..\lib-externes\Gamolf-FMX-Game-Template\starter-kit-src\uGameData.pas',
  Olf.RTL.Streams in '..\..\lib-externes\librairies\src\Olf.RTL.Streams.pas',
  Olf.RTL.Maths.Conversions in '..\..\lib-externes\librairies\src\Olf.RTL.Maths.Conversions.pas',
  uBackgroundMusic in '..\..\lib-externes\Gamolf-FMX-Game-Template\starter-kit-src\uBackgroundMusic.pas',
  uSoundEffects in 'uSoundEffects.pas',
  uDMGameControllerCenter in '..\..\lib-externes\Gamolf-FMX-Game-Template\starter-kit-src\uDMGameControllerCenter.pas' {DMGameControllerCenter: TDataModule},
  uDMHelpBarManager in '..\..\lib-externes\Gamolf-FMX-Game-Template\starter-kit-src\uDMHelpBarManager.pas' {HelpBarManager: TDataModule},
  ...
  fMain in '..\..\lib-externes\Gamolf-FMX-Game-Template\starter-kit-src\fMain.pas' {frmMain},
  uSVGBitmapManager in 'uSVGBitmapManager.pas',
  USVGInputPrompts in '..\..\assets\kenney_nl\InputPrompts\USVGInputPrompts.pas',
  _ScenesAncestor in '..\..\lib-externes\Gamolf-FMX-Game-Template\starter-kit-src\_AncestorsForScenesAndUIElements\_ScenesAncestor.pas' {__SceneAncestor: TFrame};
